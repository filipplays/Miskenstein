...
// Odkomentirati je potrebno ustrezno definicijo makroja. S tem povzročimo, da bo obstajal
...
// Definirati je potrebno, če se uporablja DMA in kateri v obliki: hdma_memtomem_dmaX_channelY
// Če ne, zakomentiraj spodnjo vrstico
#define hLCD_USE_DMA
#define hLCDDMA		hdma_memtomem_dma1_channel2

// Potrebno je specificirati resolucijo LCD zaslona.
#define ILI9341_WIDTH  		240U		// širina zaslona v številu pikslov
#define ILI9341_HEIGHT 		320U		// višina zaslona v številu pikslov
